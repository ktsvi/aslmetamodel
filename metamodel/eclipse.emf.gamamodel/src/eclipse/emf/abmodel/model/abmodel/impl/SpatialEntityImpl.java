 ...
 * </p>
 * <ul>
 *   <li>{@link eclipse.emf.abmodel.model.abmodel.impl.SpatialEntityImpl#getShapeName <em>Shape Name</em>}</li>
 *   <li>{@link eclipse.emf.abmodel.model.abmodel.impl.SpatialEntityImpl#getShapePath <em>Shape Path</em>}</li>
 *   <li>{@link eclipse.emf.abmodel.model.abmodel.impl.SpatialEntityImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpatialEntityImpl extends MinimalEObjectImpl.Container implements SpatialEntity {
	...
	protected EClass eStaticClass() {
		return AbmodelPackage.Literals.SPATIAL_ENTITY;
	}
	...
	public void setShapeName(String newShapeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbmodelPackage.SPATIAL_ENTITY__SHAPE_NAME, oldShapeName, shapeName));
	}
	...
	public void setShapePath(String newShapePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbmodelPackage.SPATIAL_ENTITY__SHAPE_PATH, oldShapePath, shapePath));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbmodelPackage.SPATIAL_ENTITY__TYPE, oldType, type));
	}
