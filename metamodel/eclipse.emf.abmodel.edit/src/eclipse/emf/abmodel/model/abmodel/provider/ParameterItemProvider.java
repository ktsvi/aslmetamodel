...
/**
 * This is the item provider adapter for a {@link eclipse.emf.abmodel.model.abmodel.Parameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_paramName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_paramName_feature", "_UI_Parameter_type"),
				 AbmodelPackage.Literals.PARAMETER__PARAM_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AbmodelPackage.Literals.PARAMETER__TARGET_VARIABLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Parameter)object).getParamName();
