...
/**
 * This is the item provider adapter for a {@link eclipse.emf.abmodel.model.abmodel.Plan} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlanItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Plan_planName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Plan_planName_feature", "_UI_Plan_type"),
				 AbmodelPackage.Literals.PLAN__PLAN_NAME,
				 true,
				 false,
				 false,
	...
	protected void addIntentionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Plan_intention_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Plan_intention_feature", "_UI_Plan_type"),
				 AbmodelPackage.Literals.PLAN__INTENTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Plan)object).getPlanName();
