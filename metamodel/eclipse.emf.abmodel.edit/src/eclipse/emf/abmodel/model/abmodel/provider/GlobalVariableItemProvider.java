...
/**
 * This is the item provider adapter for a {@link eclipse.emf.abmodel.model.abmodel.GlobalVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GlobalVariableItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addGvarNamePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GlobalVariable_init_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GlobalVariable_init_feature", "_UI_GlobalVariable_type"),
				 AbmodelPackage.Literals.GLOBAL_VARIABLE__INIT,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Gvar Name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addGvarNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GlobalVariable_gvarName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GlobalVariable_gvarName_feature", "_UI_GlobalVariable_type"),
				 AbmodelPackage.Literals.GLOBAL_VARIABLE__GVAR_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AbmodelPackage.Literals.GLOBAL_VARIABLE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addInitValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GlobalVariable_initValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GlobalVariable_initValue_feature", "_UI_GlobalVariable_type"),
				 AbmodelPackage.Literals.GLOBAL_VARIABLE__INIT_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((GlobalVariable)object).getGvarName();
