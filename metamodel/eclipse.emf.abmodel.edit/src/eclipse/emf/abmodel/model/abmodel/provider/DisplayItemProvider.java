...
/**
 * This is the item provider adapter for a {@link eclipse.emf.abmodel.model.abmodel.Display} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DisplayItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Display_displayName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Display_displayName_feature", "_UI_Display_type"),
				 AbmodelPackage.Literals.DISPLAY__DISPLAY_NAME,
				 true,
				 false,
				 false,
	...
	protected void addDisplayTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Display_displayType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Display_displayType_feature", "_UI_Display_type"),
				 AbmodelPackage.Literals.DISPLAY__DISPLAY_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Display)object).getDisplayName();
