...
/**
 * This is the item provider adapter for a {@link eclipse.emf.abmodel.model.abmodel.Monitor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MonitorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Monitor_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Monitor_label_feature", "_UI_Monitor_type"),
				 AbmodelPackage.Literals.MONITOR__LABEL,
				 true,
				 false,
				 false,
	...
	protected void addTargetVarPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Monitor_targetVar_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Monitor_targetVar_feature", "_UI_Monitor_type"),
				 AbmodelPackage.Literals.MONITOR__TARGET_VAR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Monitor)object).getLabel();
